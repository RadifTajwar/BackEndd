...
client = Client()
msg = (
    "Take the following INPUT and for each item in the list return the structure [CHARACTER ACTION in LOCATION]. If you can't figure out the location, you can make it up.Replace any character name with its species name. Give the result OUTPUT2 below  "
"INPUT1:"
